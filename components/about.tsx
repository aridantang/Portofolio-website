      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <div className="lg:col-span-8 space-y-12">
          <div className="space-y-6">
            <p className="text-2xl md:text-3xl font-medium text-foreground leading-relaxed max-w-2xl">
              {"👋 Hi! I am Surya. "}
            </p>
            <p className="text-lg md:text-xl text-foreground leading-relaxed max-w-2xl">
              {"Senior Product Designer specializing in SaaS platforms, data visualization, and operational interfaces. With "}<span className="text-accent font-bold">7+ years</span>{" of experience spanning fintech and consulting."}
            </p>
